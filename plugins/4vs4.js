        ...
        const buttons = [
            {
                ...
                buttonText: { displayText: "𝘑𝘶𝘨𝘢𝘥𝘰𝘳.🗣️" },
                type: 1,
            },
            {
...
▸ .4𝘷𝘴4 21:00 𝘊𝘓𝘒 
▸ .4𝘷𝘴4 9:00 𝘊𝘓𝘒
▸ 𝘜𝘯𝘢 𝘷𝘦𝘻 𝘦𝘴𝘵𝘢𝘣𝘭𝘦𝘤𝘪𝘥𝘢 𝘭𝘢 𝘩𝘰𝘳𝘢 𝘺 𝘮𝘰𝘥𝘢𝘭𝘪𝘥𝘢𝘥, 𝘶𝘴𝘢 𝘭𝘰𝘴 𝘣𝘰𝘵𝘰𝘯𝘦𝘴 𝘱𝘢𝘳𝘢 𝘢𝘯𝘰𝘵𝘢𝘳𝘵𝘦. 🗣️
        `.trim();
    ...
    if (args[0].toLowerCase() === 'anotar') {
        ...
        if (equipo.includes(nombre) || suplentes.includes(nombre)) {
            await m.reply(`> *_${nombre}_* 𝘠𝘢 𝘦𝘴𝘵𝘢𝘴 𝘢𝘯𝘰𝘵𝘢𝘥𝘰 𝘦𝘯 𝘭𝘢 𝘭𝘪𝘴𝘵𝘢.🗣️`);
            return;
        }
        ...
        if (index !== -1) {
            equipo[index] = nombre;
            await m.reply(`> *_${nombre}_* 𝘛𝘦 𝘩𝘢𝘴 𝘢𝘯𝘰𝘵𝘢𝘥𝘰 𝘤𝘰𝘮𝘰 𝘫𝘶𝘨𝘢𝘥𝘰𝘳.🗣️`);
            await enviarLista();
        } else {
            await m.reply(`> *_${nombre}_*, 𝘦𝘭 𝘦𝘲𝘶𝘪𝘱𝘰 𝘵𝘪𝘵𝘶𝘭𝘢𝘳 𝘦𝘴𝘵á 𝘤𝘰𝘮𝘱𝘭𝘦𝘵𝘰. ¿𝘘𝘶𝘪𝘦𝘳𝘦𝘴 𝘢𝘯𝘰𝘵𝘢𝘳𝘵𝘦 𝘤𝘰𝘮𝘰 𝘴𝘶𝘱𝘭𝘦𝘯𝘵𝘦?.🗣️`);
        }
        return;
    }
    ...
    if (args[0].toLowerCase() === 'suplente') {
        ...
        if (index !== -1) {
            ...
            await m.reply(`> *_${nombre}_* 𝘛𝘦 𝘩𝘢𝘴 𝘢𝘯𝘰𝘵𝘢𝘥𝘰 𝘤𝘰𝘮𝘰 𝘴𝘶𝘱𝘭𝘦𝘯𝘵𝘦.🗣️`);
            await enviarLista();
        } else {
            await m.reply(`> *_${nombre}_*, 𝘴𝘶𝘱𝘭𝘦𝘯𝘵𝘦𝘴 𝘤𝘰𝘮𝘱𝘭𝘦𝘵𝘰𝘴.🗣️`);
        }
        return;
    }
    ...
    if (args[0].toLowerCase() === 'limpiar') {
        ...
        await m.reply('> 𝘓𝘪𝘴𝘵𝘢 𝘦𝘭𝘪𝘮𝘪𝘯𝘢𝘥𝘢 𝘤𝘰𝘮𝘱𝘭𝘦𝘵𝘢𝘮𝘦𝘯𝘵𝘦. 𝘛𝘰𝘥𝘰𝘴 𝘭𝘰𝘴 𝘱𝘶𝘦𝘴𝘵𝘰𝘴 𝘦𝘴𝘵á𝘯 𝘷𝘢𝘤í𝘰𝘴 𝘢𝘩𝘰𝘳𝘢.🗣️');
        await enviarLista();
        return;
    }
}
